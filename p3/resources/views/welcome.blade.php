...
<dl>
    ...
    <dt>Scores</dt>
    <dd>At any point, an archer or guest may shoot an end, and say to themself "I wanna record that!".  They can enter that score into ASK by putting in the points scored, the distance, whether the end was timed, and selecting which event it occured at.</dd>
@endsection